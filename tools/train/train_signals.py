...
def run_train(config=CONFIG):
    ...
    g_optimizer = torch.optim.Adam(generator.parameters(), lr=config['g_lr'], betas=(0, 0.9))
    d_optimizer = torch.optim.Adam(discriminator.parameters(), lr=config['d_lr'], betas=(0, 0.9))
