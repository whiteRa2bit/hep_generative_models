...
from generation.config import FULL_SIGNAL_DIR, TRUNCATED_SIGNALS_DIR, REPEAT_COEF, FRAC_COEF, H5_DATASET_NAME
from generation.dataset.data_utils import save_h5, get_attributes_df, get_event_detector_df, generate_signals, get_detector_training_data_path, create_dir
...
def _save_detector_signals(full_signals, trunc_signals, detector):
    full_data_path = get_detector_data_path(detector)
